...
This analysis is intended for the general public, as well as the citizen scientists involved in Project FeederWatch (and the graders in Biostat 777). 
...
Project FeederWatch is a citizen science project that aims to engage individuals in North America to count birds (for as long or as little as they like) to track winter trends in bird distribution and abundance. The data dictionary is available [here](https://drive.google.com/file/d/1kHmx2XhA2MJtEyTNMpwqTQEnoa9M7Il2/view).
...
# Common birds: irds that have several records in the dataset
...
Participants can birdwatch anywhere, it doesn't have to be at their backyard feeder! But remember the distribution of observing locations in this figure - it will be relevant for understanding the distribution of common and flocking birds below.
:::
...
#| label: fig-lat-band
# Figure 1: Bird count per latitude band
bird_count_per_day %>%
...
Most of the common birds were observed throughout the U.S. (or at least where people were reportedly birdwatching, see @fig-obs-loc). However, some birds had more limited distributions. For example, the blue jay and the northern cardinal were found predominantly in the eastern half of the U.S., and the black-capped chickadee was only observed in the more northern latitudes. 
```{r, eval=FALSE}
# Fig 3/4: Commonly sighted birds
# Since this figure takes forever to render, we'll just load in the saved figure below.
...
#| label: fig-flock
# Figure 4/5: Most abundant birds (i.e. probably largest flocks)
...
### TODO: Articles to cite:
https://www.frontiersin.org/articles/10.3389/fevo.2021.619682/full
https://ny.audubon.org/news/new-audubon-science-two-thirds-north-american-birds-risk-extinction-due-climate-change



Your analysis must include a .bib file, which you use to reference at least three unique citations.
For example, it could be to a website or paper from where the original data came from or it could be to a paper describing a method you are using to analyze the data.
